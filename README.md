## husky_navigation (indigo) - 0.1.2-0

The packages in the `husky_navigation` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo husky_navigation` on `Tue, 17 Feb 2015 20:24:15 -0000`
...
## husky_navigation (indigo) - 0.1.1-0
